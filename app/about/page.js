...
// statically importing image
import Image1 from "@/public/about-1.jpg";
import Link from "next/link";
import { getCabins } from "../_lib/data-service";
// ISR: Cache page for 1 day (86400 seconds).//3600 * 24
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2">
        {/* Static image Import, everything is figured out by next.js */}
        <Image
          src={Image1}
      ...
      {/* if we can't import static image, we can apply techniques like below to make it work  */}
      <div className="relative aspect-square  col-span-2">
        <Image
          src="/about-2.jpg"
          alt="Family that manages The Mountain-View"
          fill
